...
from agent_backend.channels.avatar_video.processors.av_sync import TIME_BASE_META_KEY
...
class AgentSimliVideoService(FrameProcessor):
    ...
    Usage (identical to the old SimliVideoService):
        from agent_backend.channels.avatar_video.processors.simli_service import AgentSimliVideoService
